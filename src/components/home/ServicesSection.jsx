...
const ServicesSection = () => {
	return (
		...
		<div className=" flex flex-col items-start justify-center gap-7 py-8">
            ...
            <p className="w-[40%] text-sm">Lorem ipsum dolor sit amet conse. Neque ullam Non, deleniti!</p>
            ...
            <div className="border btn_outline_blue_sky_blue rounded-[12px] flex flex-col items-start justify-center w-[20%] px-3 py-5 gap-3 font-semibold">
            ...
            <p className="small_card_des text-gray-300">Lorem ipsum dolor sit amet consequuntur libero dolorum fuga similique molestiae officiis atque consequatur recusandae.</p>
